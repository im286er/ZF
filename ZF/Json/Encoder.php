...
class ZF_Json_Encoder
{
     ...
     * @param $value object
     * @return string
     * @throws ZF_Exception If recursive checks are enabled and the object has been serialized previously
     */
    ...
    public static function encodeClass($className, $package = '')
    {
        ...
        if (! $cls->isInstantiable()) {
            require_once 'Zend/Json/Exception.php';
            throw new ZF_Exception("$className must be instantiable");
        }
